...
namespace WebSpider
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //Utility.ApplicationLog("WebSpider Started");
        ...
        private void StatusBarSyncTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (SpiderThread.ActiveThreadCount == 0 && SpiderThread.QueuedThreadCount == 0)
            {
                ...
                //ChangeControlState(rbtnCrawl, true);
                //ChangeControlState(rbtnUpdate, true);
        ...
        private void SaveSettings()
        {
            try
            {
                ...
                Settings.Save();
                //Utility.ApplicationLog("Application settings saved");
            }
            catch (Exception ex)
            {
